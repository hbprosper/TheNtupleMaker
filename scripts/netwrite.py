...
USAGE = '''
Usage:
  netwrite <options> <bnn-log-file-name>.bin
...
def main():
	...
	netnumber = 0
	for index in xrange(firstIndex,lastIndex+1):
		names['index'] = index
